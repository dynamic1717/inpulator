...
function getNativeButtonPosition(context, event, clampToViewport) {
  ...
  const coords = getSelectionCoords(field, meta);
  ...
  return clampToViewport(rect.left + rect.width / 2, rect.top - 8);
}

function getSelectionCoords(field, selection) {
